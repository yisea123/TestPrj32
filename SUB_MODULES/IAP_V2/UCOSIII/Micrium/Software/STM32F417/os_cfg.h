...
#define OS_CFG_CALLED_FROM_ISR_CHK_EN   1u//0u   /* Enable (1) or Disable (0) check for called from ISR                   */
...
#define OS_CFG_OBJ_TYPE_CHK_EN          1u//0u   /* Enable (1) or Disable (0) object type checking                        */
