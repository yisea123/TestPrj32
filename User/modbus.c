...
/**
  ...
  * @note   使用到全局变量,不能重入
  */
int ReadCoil(CDV_INT08U* rxBuf,CDV_INT08U rxLen, CMD_ARG *arg){//获取位状态
...
/**
  ...
  * @note   使用到全局变量,不能重入
  */
int ReadInCoil(CDV_INT08U* rxBuf,CDV_INT08U rxLen, CMD_ARG *arg){//获取位状态
...
/**
  ...
  * @note   使用到全局变量,不能重入
  */
int ReadRegister(CDV_INT08U* rxBuf,CDV_INT08U rxLen, CMD_ARG *arg){//获取位状态
...
/**
  ...
  * @note   使用到全局变量,不能重入
  */
int ReadInRegister(CDV_INT08U* rxBuf,CDV_INT08U rxLen, CMD_ARG *arg){//获取位状态
...
/**
  ...
  * @note   使用到全局变量,不能重入
  */
int WriteCoil(CDV_INT08U* rxBuf,CDV_INT08U rxLen, CMD_ARG *arg){//获取位状态
...
/**
  ...
  * @note   使用到全局变量,不能重入
  */
int WriteRegister(CDV_INT08U* rxBuf,CDV_INT08U rxLen, CMD_ARG *arg){//获取位状态
...
/**
  ...
  * @note   使用到全局变量,不能重入
  */
int WriteMultiRegister(CDV_INT08U* rxBuf,CDV_INT08U rxLen, CMD_ARG *arg){//获取位状态
