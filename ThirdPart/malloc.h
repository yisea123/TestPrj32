...
//MAX4096字节 4K
#define CCM_SEND_BUF    CCM_FLASH_WRITE_BUF - 0x1000
//MAX 8K
#define CCM_RECV_BUF    CCM_SEND_BUF - 0x2000
//MAX 4K
#define CCM_TCP_SERVER    CCM_RECV_BUF - 0x1000
//MAX 4K
#define CCM_TCP_IP    CCM_TCP_SERVER - 0x1000
//MAX 256B
#define CCM_UNIVERSALSCOM_CNT    CCM_TCP_IP - 0x100
//MAX 256B
#define CCM_CASCADE_MODBUS    CCM_UNIVERSALSCOM_CNT - 0x100
