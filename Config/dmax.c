...
{ 
	...
	if((CDV_INT32U)DMA_Streamx>(CDV_INT32U)DMA2)//得到当前stream是属于DMA2还是DMA1
	{
...
//mar:存储器地址
//ndtr:数据传输量  
void DMA_ConfigDir(DMA_Stream_TypeDef *DMA_Streamx,CDV_INT32U chx,CDV_INT32U par,CDV_INT32U mar,CDV_INT16U ndtr,CDV_INT32U dir)
{ 
